...
--
-- Host: 127.0.0.1
-- Generation Time: 13 Jul 2018 pada 15.59
...
--
-- Struktur dari tabel `history_beli`
--
...
--
-- Dumping data untuk tabel `history_beli`
--

INSERT INTO `history_beli` (`id`, `salt`, `nama`, `alamat`, `kelurahan`, `kecamatan`, `barang`, `kako`, `harga`, `status`, `waktu`) VALUES
(111, '5b4847667f852', 'si admin', 'dasdasdasdasdasdasdas', 'dasdasd', 'dasdasdas', 'Essen Cairan ALB 1.5 L', 'Depok', 100000, 'FIX', '2018-07-13 06:32:06');
...
--
DELIMITER $$
CREATE TRIGGER `delete_master_brg` AFTER DELETE ON `produk` FOR EACH ROW DELETE FROM daftar_brg WHERE daftar_brg.nama = old.nama_barang
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `new_master_brg` AFTER INSERT ON `produk` FOR EACH ROW INSERT INTO daftar_brg(nama,harga) VALUES (new.nama_barang,new.harga)
$$
DELIMITER ;
...
--
-- Dumping data untuk tabel `string`
--
...
--
-- Struktur dari tabel `testi_blog`
--
...
--
-- Dumping data untuk tabel `testi_blog`
--

INSERT INTO `testi_blog` (`id`, `link`, `create_at`) VALUES
(1, 'https://scontent-sea1-1.cdninstagram.com/vp/20811848f96ea4af8916c67033af7834/5B9ACFFD/t51.2885-15/e35/20686602_2091381050887834_3872389058634186752_n.jpg?se=7&ig_cache_key=MTU3ODkzNjE3ODEwNzEzNTg5NA%3D%3D.2', '2018-04-06 18:23:06'),
(2, 'https://scontent-sea1-1.cdninstagram.com/vp/469090e7147dc4613a3de82dbf10bafc/5B577810/t51.2885-15/e35/29740748_186723205293677_1221071898176126976_n.jpg?se=7&ig_cache_key=MTc1MTM0MjUwMzcyNTM1NTk1Ng%3D%3D.2', '2018-04-06 18:23:06'),
(3, 'https://scontent-sea1-1.cdninstagram.com/vp/4afcb63083c7ba90ad768cfa8e5f803e/5B626013/t51.2885-15/e35/29416997_2055166674772045_6453631353756844032_n.jpg?se=7&ig_cache_key=MTc1MDIzMTAzODM4MTQ3NzU1OA%3D%3D.2', '2018-04-06 18:23:06'),
(4, 'https://scontent-sea1-1.cdninstagram.com/vp/ae0172f22a0ec6b0b58ec828289c9c8a/5B722D74/t51.2885-15/e35/29717171_111736306345578_4831586179319070720_n.jpg?se=7&ig_cache_key=MTc1MTM0MjI1Mjk5ODAxMjgxOA%3D%3D.2', '2018-04-06 18:23:06'),
(5, 'https://scontent-sea1-1.cdninstagram.com/vp/3a5873b9c057729394c2b2c1be5b779a/5B6F7112/t51.2885-15/e35/29404093_235378487022561_272119601637097472_n.jpg?se=7&ig_cache_key=MTc0NzE2NzA5NTMzMzMwODcyOA%3D%3D.2', '2018-04-06 18:23:06');
...
--
-- Struktur dari tabel `trackbacks`
--
...
--
-- Struktur dari tabel `yutub_testi`
--
...
--
-- Dumping data untuk tabel `yutub_testi`
--
...
--
-- Indexes for table `alb_blog`
--
ALTER TABLE `alb_blog`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `daftar_brg`
--
...
--
-- Indexes for table `testi_blog`
--
ALTER TABLE `testi_blog`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `yutub_testi`
--
ALTER TABLE `yutub_testi`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `alb_blog`
--
ALTER TABLE `alb_blog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `daftar_brg`
--
ALTER TABLE `daftar_brg`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `testi_blog`
--
ALTER TABLE `testi_blog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `track`
  MODIFY `id_activity` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=287;

--
-- AUTO_INCREMENT for table `trackbacks`
--
ALTER TABLE `trackbacks`
  MODIFY `tb_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `yutub_testi`
--
ALTER TABLE `yutub_testi`
