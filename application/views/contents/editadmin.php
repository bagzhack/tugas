...
<head>
    ...
    <title>Edit Admin | Aplikasi Pencatatan Hutang</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0"> Edit Data <?= $admin[0]['username']?></h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    ...
                    <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit User Admin <?= $admin[0]['username']?></h4>
                                <?php echo form_open('pages/UpdateAdmin?id='.$admin[0]['id'].'') ;?>
                                    <div class="form-group">
                                        <label for="exampleInputuname2">Nama</label>
                                        <div class="input-group">
                                            <input type="text" value="<?=$admin[0]['nama']?>" class="form-control" id="exampleInputuname2" name="nama" placeholder="Nama..">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="<?=$admin[0]['username']?>" name="username" class="form-control"  placeholder="Username...">
                                            <div class="input-group-addon"><i class="ti-user"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="password" data-toggle="tooltip" title="Kosong kan Jika tidak ingin diubah" data-placement = "top" value="" name="password" class="form-control" id="exampleInputpwd2" placeholder="Password...">
                                            <div class="input-group-addon"><i class="ti-key"></i></div>
                                        </div>
                                    </div>
                                    <div class="text-left">
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Ubah</button>
                                        <a href="<?=base_url('/dataadmin')?>" class="btn btn-danger waves-effect waves-light">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
