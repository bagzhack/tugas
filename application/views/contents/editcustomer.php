...
<head>
    ...
    <title>Edit Customer | Aplikasi Pencatatan Hutang</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit Data History <?= $customer[0]['nama']?></h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    ...
                    <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Customer <?= $customer[0]['nama']?></h4>
                                <?php echo form_open('pages/UpdateCustomer?id='.$customer[0]['no_telp'].'') ;?>
                                    <div class="form-group">
                                        <label for="exampleInputuname2">Nama</label>
                                        <div class="input-group">
                                            <input type="text" value="<?=$customer[0]['nama']?>" class="form-control" id="exampleInputuname2" name="nama" placeholder="Nama..">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" value="<?=$customer[0]['no_telp']?>" name="no_telp" class="form-control" id="exampleInputEmail2" placeholder="No Telepon..">
                                            <div class="input-group-addon"><i class="ti-mobile"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputpwd2">Total Pinjaman</label>
                                        <div class="input-group">
                                            <input type="text" value="<?=$customer[0]['utang']?>" name="utang" class="form-control" id="exampleInputpwd2" placeholder="Pinjaman...">
                                            <div class="input-group-addon"><i class="ti-money"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputpwd3">Total Piutang</label>
                                        <div class="input-group">
                                            <input type="text" value="<?=$customer[0]['piutang']?>" name="piutang" class="form-control" id="exampleInputpwd3" placeholder="Piutang...">
                                            <div class="input-group-addon"><i class="ti-money"></i></div>
                                        </div>
                                    </div>
                                    <div class="text-left">
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Ubah</button>
                                        <a href="<?=base_url('/datacustomer')?>" class="btn btn-danger waves-effect waves-light">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
