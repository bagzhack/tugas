...
<head>
    ...
    <title>Data Customer | Aplikasi Pencatatan Hutang</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Data Customer</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        ...
                        <?php endif; ?>
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Export Data Customer ke format Copy, CSV, Excel, PDF & Print</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="<?= base_url('/history?id='.$value['no_telp'].'') ?>" data-toggle="tooltip" data-placement="top" title="Lihat History <?= $value['nama'] ?>"><?= $value['nama'] ?></a></td>
                                                <td><?= $value['no_telp'] ?></td>
                                                <td><?= 'Rp. '.number_format($value['utang'],0,",",".") ?></td>
                                                <td><?= 'Rp. '.number_format($value['piutang'],0,",",".") ?></td>
                                                <td><?= $value['alamat'] ?></td>
                                                <td>
                                                    <a href="<?= base_url('/deletecustomer?id='.$value['no_telp'].'') ?>" data-toggle="tooltip" data-placement="left" title="Hapus <?= $value['nama'] ?>"><i class="mdi mdi-delete"></i></a> |  <a href="<?= base_url('/editcustomer?id='.$value['no_telp'].'') ?>" data-toggle="tooltip" data-placement="top" title="Edit  <?= $value['nama'] ?>"><i class="mdi mdi-account-edit"></i></a>
                                               </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
