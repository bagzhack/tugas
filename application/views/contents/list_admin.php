                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('/deleteadmin?id='.$value['id'].'') ?>" data-toggle="tooltip" data-placement="left" title="Hapus <?= $value['username'] ?>"><i class="mdi mdi-delete"></i></a> |  <a href="<?= base_url('/editadmin?id='.$value['id'].'') ?>" data-toggle="tooltip" data-placement="top" title="Edit  <?= $value['username'] ?>"><i class="mdi mdi-account-edit"></i></a>
                                               </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
